...
for bullet in bullets:
    ...
    if random.randint(1, 100) <= 2:
        enemy_x = random.randint(enemy_radius, width - enemy_radius) enemy = pygame.Rect(enemy_x - enemy_radius, 0, enemy_radius * 2, enemy_radius * 2)
...
for bullet in bullets:
    ...
    gamme_over_text = font.render("Game Over", True, red)
